...
<jsp:include page="../../includes/header.jsp">
	<jsp:param name="title" value="Admin - Order Detail" />
</jsp:include>
									...
									<table class="table table-bordered" id="dataTable" width="100%"
										...
										<tbody>
											...
											<c:forEach var="item" items="${list }">
												<c:url var="loadUpdateLink" value="#">
												...
												<tr>
													...
													<td class="p-0"><a href="${loadOrderDetail}"
														class="btn btn-link p-2">Xem chi tiết hóa đơn</a></td>
												</tr>
