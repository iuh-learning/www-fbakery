...
<jsp:include page="../../includes/header.jsp">
	<jsp:param name="title" value="Admin - Order Preparing" />
</jsp:include>
										...
										<tbody>
											...
											<c:forEach var="item" items="${list }">
												<c:url var="loadUpdateLink"
													value="cap-nhat-thong-tin-hoa-don-dang-chuan-bi">
												...
												<tr>
													...
													<td>${item.ngayLap }</td>
													<td class="text-warning">Đang chuẩn bị</td>
													<td class="p-0">
