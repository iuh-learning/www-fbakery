...
public class HoaDonServiceImpl implements HoaDonService{
	...
	public List<HoaDon> getAllOrder(int idStatus) {
		...
		ResponseEntity<List<HoaDon>> responseEntity = restTemplate.exchange(restUrl + "/status/" + idStatus, HttpMethod.GET, null,
	...
	public void deleteOrder(int orderId) {
		logger.info("in deleteOrder(): Calling REST API " + restUrl);
		restTemplate.delete(restUrl + "/" + orderId);
		logger.info("in deleteOrder(): delete order and order detail id = " + orderId);
	}
