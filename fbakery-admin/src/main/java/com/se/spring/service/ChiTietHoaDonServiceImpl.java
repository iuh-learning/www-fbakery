...
public class ChiTietHoaDonServiceImpl implements ChiTietHoaDonService {
	...
	public List<ChiTietHoaDon> getListOrderDetailByIdOrder(int id) {
		...
		ResponseEntity<List<ChiTietHoaDon>> responseEntity = restTemplate.exchange(restUrl + "/" +id,
				HttpMethod.GET, null, new ParameterizedTypeReference<List<ChiTietHoaDon>>() {
				});
